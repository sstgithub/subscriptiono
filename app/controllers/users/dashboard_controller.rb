class Users::DashboardController < ApplicationController
  def index
    ...
    #SQL string for getting last message received for each sender_email, category combo
    ...
    # generated join_grouped_messages_on_messages_sql_str:
    ...
    #  SELECT sender_email, category, max(received_at) AS received_at
    #  FROM "messages"
    #  WHERE ("messages"."received_at" BETWEEN '#{1.year.ago}' AND '#{Time.now}')
